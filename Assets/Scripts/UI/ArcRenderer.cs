...
public class ArcRenderer : MonoBehaviour 
{
    ...
    public float arrowAngleAdjustemenet = 0;
    ...
    private void UpdateArc(Vector3 start, Vector3 mid, Vector3 end)
    {
        ...
        for (int i = 0; i < numDots && i < dotPool.Count; i++)
        {
            ...
            Vector3 position = QuadracticBezierPoint(start, mid, end, t);
    ...
    private Vector3 QuadracticBezierPoint(Vector3 start, Vector3 control, Vector3 end, float t)
    {
        float u = 1 - t;
        float tt = t * t;
        float uu = u * u;
