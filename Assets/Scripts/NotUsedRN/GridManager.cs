...
public class GridManager : MonoBehaviour
{
    ...
    public List<GameObject> gridObjects = new();

    public GameObject[,] gridCells;

    public Vector2 gridPositionPreferation;
    ...
    void CreateGrid()
    {
        ...
        for (int x = 0; x < width; x++)
        {
            ...
            {
                Vector2 gridPosition = new Vector2((x + gridPositionPreferation.x), (y+ gridPositionPreferation.y));
